		...
		<div class="col-md-12 column">
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <?php include 'conn.php'; $result = mysql_query("SELECT * FROM EmailSMS WHERE checked='unread'");
                            $num_rows = mysql_num_rows($result);?>
                            <a href="Event2.php">Leads  <span class="badge"><?php echo $num_rows;?></span></a>
                        </li>
                        <li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a data-toggle="modal" href="#myModal" class="btn btn-primary input-block-level">View Later</a>
