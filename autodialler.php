...
<script>
 function changeNumber() {
        ...
        type: 'POST',
        cache: false,
        data: 'number='+number+'&state='+state,
        success: function(data){
            alertify.success("Number changed");
			$("#number").val('');
        }
    });
} 
...
<div class="container">
  ...
  <div class="panel-heading">
    <h3 class="panel-title">Edit Primary Number</h3>
  </div>
  <div class="panel-body">
    ...
    <button type="button" class="btn btn-primary" id="createuser" onclick="changeNumber();">Apply Changes</button>
    </form>
  </div>
</div>
