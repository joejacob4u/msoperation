...
<div class="container">
  ...
  <div class="panel-heading">
    <h3 class="panel-title">Reference Logs</h3>
  </div>
...
$result = mysql_query("SELECT * FROM Reference") or die(mysql_error());
// store the record of the "tblstudent" table into $row
 
while ($row = mysql_fetch_array($result)) {

$info="The referrer is ".$row['Name2'].".<br/>Phone is ".+$row['Phone2']." \n.<br/>Email is ".$row['Email2']." \n.<br/>Note: ".$row['Note'];
    // Print out the contents of the entry 
     echo '<tr data-href="'.$info.'">';
    echo '<td>' . $row['Name'] . '</td>';
